...
// Replaced $(document).ready with vanilla JS
if (document.readyState === 'loading') {
 document.addEventListener('DOMContentLoaded', initTaintedImageReader);
} else {
 initTaintedImageReader();
}

function initTaintedImageReader() {
